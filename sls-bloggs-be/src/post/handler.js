...
export default async function message(event, context, callback) {
  ...
  switch(event.method){
    case 'GET' :
      action = { type: "GET_POST", payload: { id: event.path.id } };
      break;
    case 'DELETE' :
      action = { type: "DELETE_POST", payload: { id: event.path.id } };
      break;
    case 'POST' :
      action = { type: "CREATE_POST", payload: event.body };
      break;
    case 'PUT' :
      action = { type: "UPDATE_POST", payload: event.body };
      break;
  }
